...
const ProductManagerMongo = require("./daos/Mongo/productsManagerMongo.js")
const productManager = new ProductManagerMongo()
const router = require ("./routers/index.js")
const messageModel = require ("./daos/models/messages.model.js")
...
const { configObjet } = require ('./config/connectDB.js')
...
const httpServer = app.listen(PORT, () => {
    console.log('Desafío: Reestructura de nuestro servidor')
} )
